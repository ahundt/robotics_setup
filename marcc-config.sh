...
module load zsh/5.0.7 gcc slurm sed git tmux byobu cmake autoconf/gcc automake/gcc boost cuda/8.0 cudnn/5.1 python/2.7.12 tensorflow/cuda-8.0/r1.0 parallel_studio_xe_2015 intel-mpi readline ruby
